        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-6">
                <div class="bg-white rounded shadow p-4">
                    ...
                    <p class="font-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo quod minima
                        praesentium expedita
                        optio suscipit culpa, maiores doloremque voluptate impedit recusandae animi non, laborum sed
                        quasi. Magni velit eius temporibus!</p>
                </div>
            </main>
